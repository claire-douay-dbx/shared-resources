...
-- MAGIC - Required audit columns (audit_timestamp, source_system)
...
-- MAGIC 
-- MAGIC **Enterprise Standards Applied:**
-- MAGIC - All tables use lowercase_snake_case naming with layer prefix
-- MAGIC - All tables have audit_timestamp and source_system as last columns
